...
class Player{
	...
	checkCollision(selector){
		...
		function isCollised($div) {
			...
			var b1 = y1 + h1;
			var r1 = x1 + w1;
			var x2 = playerQuerry.offset().left;
			var y2 = playerQuerry.offset().top;
			var h2 = playerQuerry.outerHeight(true);
			var w2 = playerQuerry.outerWidth(true);
			var b2 = y2 + h2;
			var r2 = x2 + w2;
